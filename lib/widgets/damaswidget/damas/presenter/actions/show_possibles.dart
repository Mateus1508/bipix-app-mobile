...
class ShowPossibles {
  static Future<PossibleEntity> call(DamasLogic damasLogic, List<List<int>> prossibles,
      List<List<int>> board, int startX, int startY, int player) async {
    ...
    return PossibleEntity(capturePossibles, hasMoviment, endX: endX, endY: endY);
  }
}
